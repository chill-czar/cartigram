  ...
  return (
    <section className="w-full">
      ...
      <div className="grid h-[70vh] grid-cols-1 lg:grid-cols-2">
        ...
        {/* Right: Best Services */}
        <div className="flex flex-col items-center justify-center bg-[#e41e1e] px-8 py-16 text-center text-white lg:px-16 lg:py-20">
          ...
          <button className="bg-white px-8 py-3 text-sm font-bold tracking-wider text-[#e41e1e] uppercase transition-colors hover:bg-gray-100 md:px-10 md:py-4">
            READ MORE
          </button>
        </div>
      </div>
