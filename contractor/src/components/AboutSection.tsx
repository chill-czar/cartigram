  ...
  return (
    <section className="w-full bg-[#3a3a3a] py-16 md:py-20 lg:py-24">
      <div className="mx-auto max-w-4xl px-6 text-center">
        ...
        {/* Button */}
        <div>
          <button className="bg-primary px-8 py-3 text-sm font-bold tracking-wider text-white uppercase transition-colors hover:bg-[#b07000] md:px-10 md:py-4 md:text-base">
            READ MORE
          </button>
        </div>
      </div>
